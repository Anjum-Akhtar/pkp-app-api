<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_SERVER['REQUEST_URI'] === '/checkout.php') {
        ...
        if(isset($json['request_type']) && $json['request_type'] == "checkout"){  
           ...
           echo "INSERT INTO orders(INSERT INTO orders(fname,lname,company_name,street_address,country,state,city,pin,phone,email,ip_add,total_price,final_price,payment_type,payment_status,order_status) VALUES('".$fname."','".$lname."','".$company_name."','".$street_address."','".$country."','".$state."','".$city."','".$pincode."','".$phone."','".$email."','".$ip_address."','".$payment_type."','".$payment_status."','".$order_status."')";die;
            $sql = $conn->query("INSERT INTO orders(fname,lname,company_name,street_address,country,state,city,pin,phone,email,ip_add,total_price,final_price,payment_type,payment_status,order_status) VALUES('".$fname."','".$lname."','".$company_name."','".$street_address."','".$country."','".$state."','".$city."','".$pincode."','".$phone."','".$email."','".$ip_address."','".$payment_type."','".$payment_status."','".$order_status."')"); 
